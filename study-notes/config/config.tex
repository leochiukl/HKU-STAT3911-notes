...
\newcommand*{\tprob}[1]{\widetilde{\mathbb{P}}\left(#1\right)}
\newcommand*{\tprobs}[2]{\widetilde{\mathbb{P}}_{#1}\left(#2\right)}
\newcommand*{\tpr}{\widetilde{\mathbb{P}}}
\newcommand*{\expv}[1]{\mathbb{E}\left[#1\right]}
\newcommand*{\texpv}[1]{\widetilde{\mathbb{E}}\left[#1\right]}
\newcommand*{\texpvs}[2]{\widetilde{\mathbb{E}}_{#1}\left[#2\right]}
...
\newcommand*{\orc}[1]{{\color{orange!85!black}#1}}
