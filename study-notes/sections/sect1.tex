...
\defn{simple random variables} (i.e., linear combinations of finitely many indicator
...
=\expv{\vc{\indic_{A}}Z}.
\]
\emph{Step 2: Simple random variables.} Fix any pairwise disjoint events
...
simple random variables \(\{X_n\}\) such that \(0\le X_1\le X_2\le\dotsb\le X\) a.s.\ and
